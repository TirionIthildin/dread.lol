...
import { CheckCircle, Copy, Pulse, WarningCircle, ArrowSquareOut } from "@phosphor-icons/react";
    ...
    <div className="p-6 max-w-3xl space-y-8">
      <div>
        <h2 className="text-lg font-semibold text-[var(--foreground)] flex items-center gap-2">
          <Pulse className="h-6 w-6 text-[var(--accent)]" weight="duotone" aria-hidden />
          System monitoring
        </h2>
