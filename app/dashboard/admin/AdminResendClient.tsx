...
import { ArrowSquareOut, CheckCircle, Envelope, WarningCircle } from "@phosphor-icons/react";
    ...
    <div className="p-6 max-w-3xl space-y-8">
      <div>
        <h2 className="text-lg font-semibold text-[var(--foreground)] flex items-center gap-2">
          <Envelope className="h-6 w-6 text-[var(--accent)]" weight="duotone" aria-hidden />
          Resend (email)
        </h2>
            ...
            <dd className="font-mono text-xs text-[var(--foreground)] text-right">
              {ready ? (
                ...
                <span className="inline-flex items-center gap-1.5 text-[var(--warning)]">
                  <WarningCircle weight="fill" className="h-4 w-4 shrink-0" aria-hidden />
                  Not set
                </span>
              )}
            </dd>
      ...
      <section className="rounded-xl border border-[var(--border)] bg-[var(--surface)]/40 p-5 space-y-3">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-[var(--muted)]">
          <li>
            ...
            >
              Resend dashboard
              <ArrowSquareOut className="inline h-3.5 w-3.5" weight="bold" aria-hidden />
            </a>
            .
          </li>
          <li>
