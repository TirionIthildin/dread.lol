    ...
    <div className={visible ? "block space-y-4" : "hidden"}>
      ...
      <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)]/50 overflow-hidden transition-all hover:border-[var(--border-bright)]">
        <div className="px-4 py-3 border-b border-[var(--border)] flex items-center gap-2">
          <div className="rounded-lg bg-[#5865F2]/10 p-1.5">
            <MessageCircle size={18} className="fill-[#5865F2] text-[#5865F2]" aria-hidden />
          </div>
      ...
      <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)]/50 overflow-hidden transition-all hover:border-[var(--border-bright)]">
        ...
        <div className="p-4 space-y-2">
          ...
          <label className="inline-flex items-center gap-2 cursor-pointer text-sm font-medium text-[var(--foreground)] pt-2">
            <input
              type="checkbox"
              name="showDiscordAvatarDecoration"
              defaultChecked={(profile as { showDiscordAvatarDecoration?: boolean }).showDiscordAvatarDecoration !== false}
              className="rounded border-[var(--border)]"
            />
            Show Discord avatar decoration
          </label>
          <p className="text-xs text-[var(--muted)] pl-6">
            Frames your profile picture with your Nitro avatar decoration when Basics → avatar is set to use your Discord avatar.
          </p>
