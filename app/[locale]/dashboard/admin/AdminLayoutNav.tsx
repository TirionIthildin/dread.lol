...
const navItems = [
  { href: "/dashboard/admin/overview", label: "Overview", icon: BarChart3 },
  { href: "/dashboard/admin/users", label: "Users", icon: Users },
  { href: "/dashboard/admin/badges", label: "Badges", icon: Shield },
  { href: "/dashboard/admin/templates", label: "Templates", icon: LayoutGrid },
  ...
  { href: "/dashboard/admin/resend", label: "Resend", icon: Mail },
