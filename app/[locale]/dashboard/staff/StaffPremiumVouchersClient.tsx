...
export default function StaffPremiumVouchersClient() {
  ...
  const fetchStats = useCallback(async () => {
    try {
      const res = await fetch("/api/dashboard/staff/premium-voucher-stats");
      if (!res.ok) return;
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch("/api/dashboard/staff/premium-voucher", {
        method: "POST",
