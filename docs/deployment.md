...
Production layout is described in [`docker-compose.coolify.yml`](../docker-compose.coolify.yml) at the repository root. Adjust image tags, env, and volumes for your host.
