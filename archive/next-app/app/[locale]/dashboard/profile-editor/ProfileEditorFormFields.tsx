...
import { TerminalSection } from "@/app/[locale]/dashboard/profile-editor/sections/TerminalSection";
import { BasicsSection } from "@/app/[locale]/dashboard/profile-editor/sections/BasicsSection";
import { DiscordSection } from "@/app/[locale]/dashboard/profile-editor/sections/DiscordSection";
import { ExtrasSection } from "@/app/[locale]/dashboard/profile-editor/sections/ExtrasSection";
import { BannerSection } from "@/app/[locale]/dashboard/profile-editor/sections/BannerSection";
import { FunSection } from "@/app/[locale]/dashboard/profile-editor/sections/FunSection";
import { WidgetsSection } from "@/app/[locale]/dashboard/profile-editor/sections/WidgetsSection";
import { AudioSection } from "@/app/[locale]/dashboard/profile-editor/sections/AudioSection";
import { SectionTip } from "@/app/[locale]/dashboard/profile-editor/SectionTip";

const VersionsSectionLazy = dynamic(
  () =>
    import("@/app/[locale]/dashboard/profile-editor/sections/VersionsSection").then((m) => ({
  ...
  return (
    <>
      ...
      <WidgetsSection
        ...
        cryptoWalletEthereum={p.cryptoWalletEthereum}
        setCryptoWalletEthereum={p.setCryptoWalletEthereum}
        cryptoWalletBitcoin={p.cryptoWalletBitcoin}
        setCryptoWalletBitcoin={p.setCryptoWalletBitcoin}
        cryptoWalletSolana={p.cryptoWalletSolana}
        setCryptoWalletSolana={p.setCryptoWalletSolana}
