...
export default function StaffMonitoringClient() {
  ...
  const refresh = useCallback(() => {
    setLoadError(null);
    setLoading(true);
    fetch("/api/dashboard/staff/monitoring")
  ...
  async function save(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch("/api/dashboard/staff/monitoring", {
        method: "PATCH",
  ...
  async function sendTest() {
    ...
    setTestLoading(true);
    try {
      const res = await fetch("/api/dashboard/staff/monitoring/test", { method: "POST" });
